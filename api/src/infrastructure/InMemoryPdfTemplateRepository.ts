import { PdfTemplateRepository } from '../domain/ports/PdfTemplateRepository';
import { PdfTemplateDefinition } from '../domain/Template/PdfTemplate';
import { PdfTemplateGeneratorType } from '../domain/Template/PdfGenerator';

const Templates: PdfTemplateDefinition[] = [
    {
        templateId: "example2",
        inputFields: [
...
export const createInMemoryPdfTemplateRepository = (): PdfTemplateRepository => ({
    findById: async (templateId: string): Promise<PdfTemplateDefinition | null> => {
